...
<template>
  <div class="landing-legal-page page-title p-3">
    ...
    <p>
      At ibet365.co.uk, accessible from https://www.ibet365.co.uk, one of our
      main priorities is the privacy of our visitors. This Privacy Policy
      document contains types of information that is collected and recorded by
      ibet365.co.uk and how we use it.
    </p>
    ...
    <p>
      ibet365.co.uk legal basis for collecting and using the personal
    ...
    <ul>
      <li>ibet365.co.uk needs to perform a contract with you</li>
      <li>You have given ibet365.co.uk permission to do so</li>
      <li>
        Processing your personal information is in ibet365.co.uk legitimate
        interests
      </li>
      <li>ibet365.co.uk needs to comply with the law</li>
    </ul>

    <p>
      ibet365.co.uk will retain your personal information only for as long as is
    ...
    <p>
      ibet365.co.uk follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, ibet365.co.uk uses 'cookies'. These cookies are
    ...
    <P>
      ...
      advertising partners of ibet365.co.uk.
    </P>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on ibet365.co.uk, which are sent
    ...
    <p>
      Note that ibet365.co.uk has no access to or control over these cookies
    ...
    <p>
      ibet365.co.uk's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      ibet365.co.uk does not knowingly collect any Personal Identifiable
    ...
    <p>
      ...
      and/or collect in ibet365.co.uk. This policy is not applicable to any
