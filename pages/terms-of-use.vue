...
<template>
  <div class="landing-legal-page page-title p-3">
    ...
    <p>Welcome to ibet365!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of ibet365.co.uk's Website, located at https://www.ibet365.co.uk.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use ibet365 if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing ibet365, you agreed to use
      cookies in agreement with the ibet365.co.uk's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, ibet365.co.uk and/or its licensors own the
      intellectual property rights for all material on ibet365. All intellectual
      property rights are reserved. You may access this from ibet365 for your
    ...
    <p>You must not:</p>
    <ul>
      <li>Republish material from ibet365</li>
      <li>Sell, rent or sub-license material from ibet365</li>
      <li>Reproduce, duplicate or copy material from ibet365</li>
      <li>Redistribute content from ibet365</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. ibet365.co.uk
      ...
      ibet365.co.uk,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, ibet365.co.uk shall not be liable for the
    ...
    <p>
      ibet365.co.uk reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant ibet365.co.uk a non-exclusive license to use, reproduce,
    ...
    <p>
      ...
      hyperlink compensates the absence of ibet365.co.uk; and (d) the link is in
    ...
    <p>
      ...
      e-mail to ibet365.co.uk. Please include your name, your organization name,
    ...
    <p>
      No use of ibet365.co.uk's logo or other artwork will be allowed for
